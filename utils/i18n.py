class I18N:
    translations = {
        'zh-TW': {
            ...
            'update_all_btn': "全部更新 (轉檔 & 歌單)",
            'pause_btn': "暫停處理",
            'resume_btn': "繼續處理 (Resume)",
            'cancel_btn': "取消任務",
            ...
            'export_quality_label': "匯出品質 (Export Quality)",
            'export_quality_original': "保持原始品質 (Keep Original Quality)",
            'export_quality_mp3': "轉換為 MP3 (320kbps)",
            'export_quality_flac': "轉換為 FLAC (無損)",
            'export_all': "全選",
            'export_none': "全不選",
            'start_export_btn': "開始匯出所選歌單",
            'incomplete_warning_title': "警告",
            'incomplete_warning_msg': "以下歌單尚未完整，匯出至 USB 後可能會有缺歌：\n\n{0}\n\n確定要繼續匯出嗎？",
            'missing_songs': "缺 {0} 首",
            ...
            'stats_complete': "\n統計完成: 共 {0} 首歌曲待處理",
            'dl_start': "--- 開始處理流程 ---",
            'dl_progress': "({0}/{1}, 剩 {2}) [{3}] 處理: {4}",
            'dl_rest': "[休息] 已處理 {0} 首，休息 15 秒...",
            'lib_up_to_date': "太棒了! 您的音樂庫已是最新狀態，無需處理。",
            'update_complete': "\n更新完成!",
            'export_start': "\n=== 開始匯出至 USB 資料夾 ===",
            ...
            'dl_fail': "[錯誤] {0}",
            'cookie_hint': "[提示] 程式已優化，一般不需要 cookies",
            'searching': "正在搜尋: {0}...",
            ...
            'stats_songs_downloaded': "本地資料庫新增歌曲數: {0}",
            ...
            'playlist_update_counts': "已更新歌單: {0}/{1} 個",
            'dl_summary_title': "處理摘要",
            'dl_summary_chinese': "華語歌曲: {0} 首",
            'dl_summary_japanese': "日語歌曲: {0} 首",
            'dl_summary_korean': "韓語歌曲: {0} 首",
            'dl_summary_western': "西洋歌曲: {0} 首",
            'dl_summary_other': "其他/動漫: {0} 首",
            ...
            'reorganized_unsorted': " -> 已將 {0} 首已歸類歌曲從 _Unsorted 移回主音樂庫",
            'removed_songs_pl': "已移除歌曲",
            'retroactive_lyrics': "正在檢查與補抓現有歌曲的歌詞 ({0} 首)...",
            'single_tracks_pl': "單曲",
            'player_title': "播放控制",
            'player_play': "播放",
            'player_pause': "暫停",
