...
class WebviewController extends ValueNotifier<WebviewValue> {
  ...
  /// Reads all cookies (including HttpOnly) for the given URL's session via
  /// CDP Network.getAllCookies. Returns raw JSON: {"cookies":[...]}.
  Future<String> getCookiesRaw(String url) async {
    final result = await _methodChannel.invokeMethod('getCookies', url);
